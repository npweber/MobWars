                    ...
                    if(pie.getItem().equals(new ItemStack(Material.NETHER_STAR))){
                        if(InitLobbyWorld.getMatchMakingStatus()) {
                            ...
                            if (!(battlePlayers.contains(clker))) {
                                ...
                                clker.sendMessage(
                                loggingPrefix + ChatColor.GREEN
                                    + "You have been added to a list of players. When everyone wants some action, your game will start..."
                                );
                            }
                            //If they are, remove them
                                ...
                                clker.sendMessage(
                                    loggingPrefix + ChatColor.GOLD + "You have been removed from the list. You can come back anytime..."
                                );
                            }
                        } else clker.sendMessage(loggingPrefix + ChatColor.RED + "The lobby system has been disabled."
                            + " You will not find any games right now..."
                        );
                    }
                }
            }
